        ...
        <Container fluid="lg" className="hc1">
          ...
          <div className="home3 mt-5 text-center">
            ...
            <div className="home4">
              <Row>
                <Col>
                  <Card style={{ width: "18rem" }} className="homecrd">
                    <Card.Img variant="top" src="https://i.postimg.cc/CK8hj0Hy/play-button-unscreen.gif" height="300px" width="300" />
                    <Card.Body>
                ...
                <Col>
                  <Card style={{ width: "18rem" }} className="homecrd">
                    <Card.Img variant="top" src="https://i.postimg.cc/nzkK34VJ/catogrise.gif" height="300px" width="300" />
                    <Card.Body>
                ...
                <Col>
                  <Card style={{ width: "18rem" }} className="homecrd">
                    <Card.Img variant="top" src="https://i.postimg.cc/ZYpJTSbg/watch-history.gif" height="300px" width="300"/>
                    <Card.Body>
